...
TOKEN = '7639383330:AAHP4eF4H11b3PcXSFujhKeUAnMGEEKon9M'  # Replace with your actual bot token
ADMIN_IDS = [6483031462]  # Added new admin ID
CHANNEL_ID = '5898718899'  # Replace with your specific channel or group ID
# Initialize the bot
...
def reset_attack_limit(message):
    owner_id = 5898718899 # Replace with the actual owner ID
    ...
    response = (
        ...
        "━━━━━━━━━━━━━━━━━━━\n"
        "🔗 *𝗣𝗢𝗪𝗘𝗥𝗘𝗗 𝗕𝗬: [𝐏𝐤 𝐂𝐡𝐨𝐩𝐫𝐚](https://t.me/@your username) ⚡*"
    )
...
FEEDBACK_CHANNEL_ID = "5898718899"  # Replace with your actual feedback channel ID
